...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/hiredcoin-cli.cpp \
           src/hiredcoin-tx.cpp \
           src/hiredcoin.cpp \
           src/db.cpp \
           ...
           src/qt/hiredcoin.cpp \
           src/qt/hiredcoinstrings.cpp \
...
RESOURCES += src/qt/hiredcoin.qrc src/qt/hiredcoin_locale.qrc

TRANSLATIONS += src/qt/locale/hiredcoin_bg.ts \
                src/qt/locale/hiredcoin_de.ts \
                src/qt/locale/hiredcoin_en.ts \
                src/qt/locale/hiredcoin_es.ts \
                src/qt/locale/hiredcoin_fi.ts \
                src/qt/locale/hiredcoin_fr.ts \
                src/qt/locale/hiredcoin_it.ts \
                src/qt/locale/hiredcoin_ja.ts \
                src/qt/locale/hiredcoin_pl.ts \
                src/qt/locale/hiredcoin_pt.ts \
                src/qt/locale/hiredcoin_ru.ts \
                src/qt/locale/hiredcoin_sk.ts \
                src/qt/locale/hiredcoin_sv.ts \
                src/qt/locale/hiredcoin_vi.ts \
                src/qt/locale/hiredcoin_zh_CN.ts \
                src/qt/locale/hiredcoin_zh_TW.ts

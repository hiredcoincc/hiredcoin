Contributing to HRD Core
============================

The HRD Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HRD Core project, and is not to be
confused with overall HRD Network Protocol consensus changes.

Whether a pull request is merged into HRD Core rests with the project merge
...
Patches that change HRD consensus rules are considerably more involved than
...
Where a patch set proposes to change the HRD consensus, it must have been
...
The project leader is the release manager for each HRD Core release.

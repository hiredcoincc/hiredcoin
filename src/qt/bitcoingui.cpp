                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HRD Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HRD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hiredcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHRD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HRD Core"), this);
    aboutAction->setStatusTip(tr("Show information about HRD Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HRD"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HRD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HRD addresses"));
    ...
    openAction->setStatusTip(tr("Open a HRD: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HRD Core help message to get a list with possible HRD command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HRD Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HRD network", "", count));
}
...
{
    QString strTitle = tr("HRD Core"); // default title

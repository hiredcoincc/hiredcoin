...
/** Utility functions used by the HRD Qt UI.
 */
namespace GUIUtil
{
...
// Render HRD addresses in monospace font
...
// Parse "hiredcoin:" URI into recipient object, return true on successful parsing

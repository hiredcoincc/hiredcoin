...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HiredCoin features */
        {"hiredcoin", "masternode", &masternode, true, true, false},
        {"hiredcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"hiredcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hiredcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hiredcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hiredcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"hiredcoin", "startmasternode", &startmasternode, true, true, false},
        {"hiredcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hiredcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hiredcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hiredcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hiredcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hiredcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hiredcoin", "mnbudget", &mnbudget, true, true, false},
        {"hiredcoin", "preparebudget", &preparebudget, true, true, false},
        {"hiredcoin", "submitbudget", &submitbudget, true, true, false},
        {"hiredcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hiredcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hiredcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hiredcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hiredcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hiredcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hiredcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hiredcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"hiredcoin", "mnsync", &mnsync, true, true, false},
        {"hiredcoin", "spork", &spork, true, true, false},
        {"hiredcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hiredcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hiredcoind, or the -server option to hiredcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hiredcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38573/\n";
}

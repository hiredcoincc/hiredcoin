...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HiredCoin Core hiredcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hiredcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hiredcoin transaction") + "\n" +
                               "  hiredcoin-tx [options] -create [commands]   " + _("Create hex-encoded hiredcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hiredcoin transaction

 ...
 * HRD system. There are three: the main network on which people trade goods
...
public:
    ...
    CAmount MasternodeHoldCoins() const { return nMasternodeHoldCoins; }

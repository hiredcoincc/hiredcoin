...
In order to support loading of multiple wallets in hiredcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hiredcoin.cpp.
...
Changes to hiredcoin.cpp
----------------------
hiredcoin.cpp is the entry point into hiredcoin-qt, and as such, will require some minor modifications to provide hooks for

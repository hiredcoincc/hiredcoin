...
#   c) node1 mines 32 blocks, so now node 0 has 60001hiredcoin, node 1 has 4250hiredcoin, node2 has none.
#   d) node0 sends 601 hiredcoin to node2, in two transactions (301 hiredcoin, then 300 hiredcoin).
